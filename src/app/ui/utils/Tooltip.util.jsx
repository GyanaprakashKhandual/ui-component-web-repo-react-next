      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className={`
              absolute z-50 bg-[#3c4043] text-white text-[13px] leading-4.5 px-2.5 py-1.5 rounded shadow-[0_2px_8px_rgba(0,0,0,0.26)] whitespace-nowrap font-semi-bold pointer-events-none
